...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		store.setDefault(PreferenceConstants.P_SERVERADDRESS, "https://index.docker.io/v1/");
		store.setDefault(PreferenceConstants.P_USERNAME, "osswangxining");
		store.setDefault(PreferenceConstants.P_PASSWORD, "****************");
		store.setDefault(PreferenceConstants.P_EMAIL, "osswangxining@163.com");
	}
