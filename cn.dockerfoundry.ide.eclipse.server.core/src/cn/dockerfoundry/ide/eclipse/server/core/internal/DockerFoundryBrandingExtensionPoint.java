 ...
 * @author Terry Denney
 */
public class DockerFoundryBrandingExtensionPoint {
	...
	public static String POINT_ID = "cn.dockerfoundry.ide.eclipse.server.core.branding"; //$NON-NLS-1$
	...
	public static class CloudServerURL {
		...
		public CloudServerURL(String name, String url, boolean userDefined, String signupURL, DockerConnectionElement dockerConnElem) {
			this.name = name;
			this.url = url;
			this.userDefined = userDefined;
			this.signupURL = signupURL;
