...
public class DockerFoundryApplicationModule extends ExternalModule implements IDockerFoundryApplicationModule {

	public static String APPLICATION_STATE_DEPLOYABLE = Messages.DockerFoundryApplicationModule_STATE_DEPLOYABLE;

	public static String APPLICATION_STATE_DEPLOYED = Messages.DockerFoundryApplicationModule_STATE_DEPLOYED;

	public static String APPLICATION_STATE_UPLOADING = Messages.DockerFoundryApplicationModule_STATE_UPLOADING;

	public static String DEPLOYMENT_STATE_LAUNCHED = Messages.DockerFoundryApplicationModule_STATE_LAUNCHED;

	public static String DEPLOYMENT_STATE_LAUNCHING = Messages.DockerFoundryApplicationModule_STATE_LAUNCHING;

	public static String DEPLOYMENT_STATE_STARTING_SERVICES = Messages.DockerFoundryApplicationModule_STATE_STARTING_SERVICES;

	public static String DEPLOYMENT_STATE_STOPPED = Messages.DockerFoundryApplicationModule_STATE_STOPPED;

	public static String DEPLOYMENT_STATE_STOPPING = Messages.DockerFoundryApplicationModule_STATE_STOPPING;

	public static String DEPLOYMENT_STATE_WAITING_TO_LAUNCH = Messages.DockerFoundryApplicationModule_STATE_WAITING_TO_LAUNCH;

	private static final String MODULE_ID = "cn.dockerfoundry.ide.eclipse.server.core.CloudFoundryApplicationModule"; //$NON-NLS-1$
	 ...
	 * @param server. Must not be null.
	 */
	public DockerFoundryApplicationModule(String deployedApplicationName, IServer server) {
		this(null, deployedApplicationName, deployedApplicationName, server);
	}

	protected DockerFoundryApplicationModule(IModule module, String deployedApplicationName, String localName,
			IServer server) {
		...
		DockerFoundryPlugin.trace("Created ApplicationModule " + deployedApplicationName + " for module " + module); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected DockerFoundryServer getCloudFoundryServer() {
		return (DockerFoundryServer) server.loadAdapter(DockerFoundryServer.class, null);
	}
	...
	protected class ModuleDeploymentInfoWorkingCopy extends DeploymentInfoWorkingCopy {
		...
		protected ModuleDeploymentInfoWorkingCopy(DockerFoundryApplicationModule appModule) {
			super(appModule);
		}
