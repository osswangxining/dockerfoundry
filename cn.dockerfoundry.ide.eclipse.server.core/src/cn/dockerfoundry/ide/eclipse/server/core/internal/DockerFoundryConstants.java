...
public class DockerFoundryConstants {
	...
	public static final String PUBLIC_CF_SERVER_SIGNUP_LABEL = Messages.DockerFoundryConstants_LABEL_SIGNUP;

	public static final String PROPERTY_MODULE_NO_FACET = "cn.dockerfoundry.ide.eclipse.server.core.property.PROPERTY_MODULE_NO_FACET"; //$NON-NLS-1$
