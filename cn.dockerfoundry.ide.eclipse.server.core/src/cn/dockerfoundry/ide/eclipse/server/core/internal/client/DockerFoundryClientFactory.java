 ...
 * 
 * @see cn.dockerfoundry.ide.eclipse.server.core.internal.client.ClientRequest
 * 
 * 
 */
public class DockerFoundryClientFactory {

	private static DockerFoundryClientFactory sessionFactory = null;

	public static DockerFoundryClientFactory getDefault() {
		if (sessionFactory == null) {
			sessionFactory = new DockerFoundryClientFactory();
		}
