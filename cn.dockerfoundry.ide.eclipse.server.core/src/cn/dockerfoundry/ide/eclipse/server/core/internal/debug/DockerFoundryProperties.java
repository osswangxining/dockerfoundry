 ...
 * 
 */
public enum DockerFoundryProperties {

	isServerSupported {
		public boolean testProperty(IModule[] modules, DockerFoundryServer cloudFoundryServer) {
	...
	isCloudModuleLocal {
		public boolean testProperty(IModule[] modules, DockerFoundryServer cloudFoundryServer) {
			if (modules != null && modules.length > 0) {
				...
				DockerFoundryApplicationModule cloudModule = cloudFoundryServer.getExistingCloudModule(modules[0]);
				if (cloudModule != null) {
