...
import org.dockerfoundry.ide.eclipse.server.core.internal.CloudFoundryCallback;
...
import org.dockerfoundry.ide.eclipse.server.core.internal.log.CloudLog;
import org.dockerfoundry.ide.eclipse.server.ui.internal.console.ConsoleManagerRegistry;
...
//							shouldClearConsole, subMonitor.newChild(100));
	...
	@Override
	public void printToConsole(CloudFoundryServer cloudServer, 
	...
	public void stopApplicationConsole(CloudFoundryServer cloudServer) {
