...
public class CloudFoundryConsole {
	static final String ATTRIBUTE_SERVER = "org.dockerfoundry.ide.eclipse.server.Server"; //$NON-NLS-1$ 

	static final String ATTRIBUTE_APP = "org.dockerfoundry.ide.eclipse.server.CloudApp"; //$NON-NLS-1$ 

	static final String ATTRIBUTE_INSTANCE = "org.dockerfoundry.ide.eclipse.server.CloudInstance"; //$NON-NLS-1$ 

	static final String CONSOLE_TYPE = "org.dockerfoundry.ide.eclipse.server.appcloud"; //$NON-NLS-1$ 
