...
import org.dockerfoundry.ide.eclipse.server.core.internal.CloudServerEvent;
import org.dockerfoundry.ide.eclipse.server.core.internal.CloudServerListener;
import org.dockerfoundry.ide.eclipse.server.core.internal.DockerApplicationService;
import org.dockerfoundry.ide.eclipse.server.core.internal.ServerEventHandler;
import org.dockerfoundry.ide.eclipse.server.core.internal.client.CloudFoundryApplicationModule;
import org.dockerfoundry.ide.eclipse.server.core.internal.client.CloudRefreshEvent;
...
import org.dockerfoundry.ide.eclipse.server.ui.internal.actions.RefreshEditorAction;
import org.dockerfoundry.ide.eclipse.server.ui.internal.actions.EditorAction.EditorCloudEvent;
...
public class CloudFoundryApplicationsEditorPage extends ServerEditorPart {
	...
	private List<DockerApplicationService> services;
	...
	public List<DockerApplicationService> getServices() {
		return services;
	}
	...
	public void setServices(List<DockerApplicationService> services) {
	...
	private class RefreshEditorOperation {
		...
		public void run(IProgressMonitor monitor) {
			...
			try {
				services = cloudServer.getBehaviour().getServices(monitor);
				if (services == null) {
			...
			if (event instanceof CloudRefreshEvent
				...
				List<DockerApplicationService> services = ((CloudRefreshEvent) event).getServices();
