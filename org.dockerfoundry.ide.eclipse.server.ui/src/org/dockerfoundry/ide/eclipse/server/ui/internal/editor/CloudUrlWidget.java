...
import org.dockerfoundry.ide.eclipse.server.core.internal.CloudFoundryBrandingExtensionPoint.CloudServerURL;
...
//		});
	...
	protected void setUpdatedSelectionInServer() {
		...
		if (url != null) {
			...
			cfServer.setUrl(url);
			String name = CloudUiUtil.getNameFromDisplayText(getURLSelection());
			CloudServerURL cloudServerURL = CloudUiUtil.getCloudServerURL(name);
			if(cloudServerURL != null){
				cfServer.setDockerConnElem(cloudServerURL.getDockerConnElem());
			}
		}
