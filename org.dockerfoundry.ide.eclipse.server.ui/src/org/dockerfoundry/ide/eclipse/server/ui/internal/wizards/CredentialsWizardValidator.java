...
import org.dockerfoundry.ide.eclipse.server.ui.internal.ServerWizardValidator;
import org.dockerfoundry.ide.eclipse.server.ui.internal.ValidationStatus;
...
public class CredentialsWizardValidator extends ServerWizardValidator {
	...
	protected ValidationStatus validateLocally() {
		...
		/*if (userName == null || userName.trim().length() == 0) {
			...
			message = NLS.bind(Messages.SELECT_SERVER_URL, "");
		}
		else {
			valuesFilled = true;
