...
import org.dockerfoundry.ide.eclipse.server.core.internal.debug.CloudFoundryProperties;
...
import org.dockerfoundry.ide.eclipse.server.ui.internal.actions.ServiceToApplicationsBindingAction;
...
public class ApplicationMasterPart extends SectionPart {
	...
	private List<DockerApplicationService> services = new ArrayList<DockerApplicationService>();
...
//		createRoutesDomainsSection();
	...
	private void updateSections() {
		List<DockerApplicationService> services = editorPage.getServices();
