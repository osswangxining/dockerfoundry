 ...
 */
public class DockerFoundryServiceWizard extends Wizard {

	private WizardDialog parent;

	private final DockerFoundryServer cloudServer;

	private DockerFoundryServiceWizardPage page;
	 ...
	 * @param cloudServer
	 */
	public DockerFoundryServiceWizard(DockerFoundryServer cloudServer) {
	 ...
	 */
	public DockerFoundryServiceWizard(DockerFoundryServer cloudServer, boolean deferServiceAddition) {
	...
	public void addPages() {
		page = new DockerFoundryServiceWizardPage(cloudServer, this);
		addPage(page);
	}
	...
	private static class ServiceCreationJob extends Job {
		...
		final DockerFoundryServer cloudServer;

		final List<List<ServiceInstance>>  servicesToCreate;

		public ServiceCreationJob(List<List<ServiceInstance>>  servicesToCreate, DockerFoundryServer cloudServer) {
			super(Messages.DockerFoundryServiceWizard_JOB_TASK_CREATING_SERVICES);
