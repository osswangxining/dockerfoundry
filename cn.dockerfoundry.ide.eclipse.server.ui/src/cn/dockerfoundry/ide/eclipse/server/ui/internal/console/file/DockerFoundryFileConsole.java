 ...
 * @author Nieraj Singh
 */
class DockerFoundryFileConsole extends JobChangeAdapter {

	static final String ATTRIBUTE_SERVER = "cn.dockerfoundry.ide.eclipse.server.Server"; //$NON-NLS-1$

	static final String ATTRIBUTE_APP = "cn.dockerfoundry.ide.eclipse.server.CloudApp"; //$NON-NLS-1$

	static final String ATTRIBUTE_INSTANCE = "cn.dockerfoundry.ide.eclipse.server.CloudInstance"; //$NON-NLS-1$

	static final String CONSOLE_TYPE = "cn.dockerfoundry.ide.eclipse.server.appcloud"; //$NON-NLS-1$
...
//	private final CloudFoundryApplicationModule app;
	...
	public DockerFoundryFileConsole(MessageConsole console) {
//		this.app = app;
	...
	static String getConsoleName(DockerFoundryApplicationModule app) {
