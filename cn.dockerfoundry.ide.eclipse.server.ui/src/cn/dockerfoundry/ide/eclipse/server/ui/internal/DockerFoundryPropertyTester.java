 ...
 * 
 */
public class DockerFoundryPropertyTester extends PropertyTester {
	...
	public boolean test(Object receiver, String property, Object[] arg2, Object expectedValue) {
		...
		IServer server = null;
		DockerFoundryServer cloudFoundryServer = null;
		// Handle the TreeSelection
		if (receiver instanceof StructuredSelection) {
			Object obj = ((StructuredSelection)receiver).getFirstElement();
			if (obj instanceof IServer) {
			   server = (IServer) obj;
			   cloudFoundryServer = (DockerFoundryServer) server.loadAdapter(DockerFoundryServer.class, null);
		...
		if (cloudFoundryServer != null) {
			DockerFoundryProperties cfProperty = DockerFoundryProperties.valueOf(property);
	...
	protected DockerFoundryServer getCloudFoundryServer(IServerModule serverModule) {
