 ...
 *
 */
public abstract class DockerFoundryConsoleStream extends BaseConsoleStream implements ICloudFoundryConsoleStream {
	...
	public DockerFoundryConsoleStream(DockerFoundryServer server, int swtColour, String appName, int instanceIndex) {
		this.server = server;
