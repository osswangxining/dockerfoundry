...
import cn.dockerfoundry.ide.eclipse.server.core.internal.log.HttpTracer;

/**
 * Preference page to enable/disable Cloud Foundry HTTP verbose tracing.
 */
public class DockerFoundryTracePreferencePage extends PreferencePage implements IWorkbenchPreferencePage {

	private boolean isTracingEnabled;

	public DockerFoundryTracePreferencePage() {
		setPreferenceStore(DockerFoundryServerUiPlugin.getDefault().getPreferenceStore());
	}
