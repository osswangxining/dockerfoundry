...
import cn.dockerfoundry.ide.eclipse.server.ui.internal.EnvironmentVariablesPart;
import cn.dockerfoundry.ide.eclipse.server.ui.internal.Messages;

public class DockerFoundryApplicationEnvVarWizardPage extends PartsWizardPage {
	...
	public DockerFoundryApplicationEnvVarWizardPage(DockerFoundryServer cloudServer,
			ApplicationDeploymentInfo deploymentInfo, DockerContainerInfo dockerContainerInfo) {
		super(Messages.DockerFoundryApplicationEnvVarWizardPage_TEXT_ENV_VAR_WIZ, null, null);
	...
	public void createControl(Composite parent) {
		...
		setDescription(Messages.DockerFoundryApplicationEnvVarWizardPage_TEXT_EDIT_ENV_VAR);
