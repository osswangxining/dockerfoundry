 ...
 * @author Terry Denney
 */
public class DockerFoundryImages {

	private static final URL baseURL = DockerFoundryServerUiPlugin.getDefault().getBundle().getEntry("/icons/"); //$NON-NLS-1$
	...
	public static ImageDescriptor getWizardBanner(String serverTypeId) {
		IConfigurationElement config = DockerFoundryBrandingExtensionPoint.getConfigurationElement(serverTypeId);
		String wizBanner = DockerFoundryBrandingExtensionPoint.getWizardBannerPath(serverTypeId);
