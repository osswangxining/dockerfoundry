...
public class DockerFoundryPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	protected Control createContents(Composite parent) {
		...
		serviceLabel.setText(Messages.DockerFoundryPreferencePage_TEXT_SELECT_CF_FEATURE);
