...
public abstract class BaseClientRequest<T> {
	...
	public T run(IProgressMonitor monitor) throws CoreException {
		...
		DockerClient client = getClient(subProgress);
		if (client == null) {
...
//		HttpTracer.getCurrent().trace(client);
	 ...
	 */
	protected abstract T doRun(DockerClient client, SubMonitor progress) throws CoreException;
	 ...
	 */
	protected abstract DockerClient getClient(IProgressMonitor monitor) throws CoreException;
