...
//				getBehaviour().getCloudFoundryServer().updateModules(deployedApplicationsByName);
				getBehaviour().createDockerContainerAsServer(subMonitor.newChild(20));
				subMonitor.worked(20);
			
//				List<DockerApplicationService> services = getBehaviour().getServices(subMonitor.newChild(20));
